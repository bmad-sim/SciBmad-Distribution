# Patched for AppBundler: GLMakie's @setup_workload/@compile_workload block (lines 3-58
# of the upstream file) opens an OpenGL screen, which is not available while packages are
# precompiled into the bundle. It is commented out below; the static precompile()
# statements at the end are kept verbatim. Regenerate this file when GLMakie is upgraded.
# Upstream source: GLMakie v0.13.13, src/precompiles.jl
